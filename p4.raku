...
with Cmd-Des.parsefile('p4-help-cmds.txt').made {
  ...
  $p4fc.say: 'complete -f -c p4 -n "__fish_seen_subcommand_from help" -a help -d "Print the requested help message"';
  $p4fc.say: 'complete -f -c p4 -n "__fish_seen_subcommand_from $p4_client_commands" -l explain -d "display additional information about the flags"';
  for .kv -> $c, $d {
